...
export function CardInfoRail({ className = '', overall, positionAbbr }: CardInfoRailProps) {
  return (
    <div className={`flex flex-col items-center gap-[2.2cqw] text-secondary ${className}`}>
      <span className="font-display text-[16cqw] font-bold leading-none">{overall ?? '—'}</span>
